...
Source Database       : easyts

Target Server Type    : MYSQL
Target Server Version : 50722
File Encoding         : 65001

Date: 2018-05-07 22:03:35
*/
...
-- ----------------------------
INSERT INTO `ts_config` VALUES ('abstract', '公司简介', '公司简介', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('address', '公司地址', '公司地址', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('admin_pwd', '管理员密码', '625c7cd8ee4c55b37ee1a6fb85c0be10', 'b538307d-44f5-3563-5783-c60792448230', '(已加密,输入明文即可修改)');
INSERT INTO `ts_config` VALUES ('company_name', '公司名称', '公司名称', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('email', '邮箱', '邮箱', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('fax', '传真', '传真', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('record', '备案号', '备案号', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('site_name', '网站标题', '网站标题', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('tel', '联系电话', '联系电话', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('web_discription', 'SEO 网站描述', 'SEO 网站描述', 'b538307d-44f5-3563-5783-c60792448230', '');
INSERT INTO `ts_config` VALUES ('web_keyword', 'SEO 关键词', 'SEO 关键词', 'b538307d-44f5-3563-5783-c60792448230', '');

-- ----------------------------
-- Table structure for ts_data
-- ----------------------------
DROP TABLE IF EXISTS `ts_data`;
CREATE TABLE `ts_data` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `raw` json NOT NULL COMMENT '原始数据',
  `client_id` char(40) DEFAULT NULL,
